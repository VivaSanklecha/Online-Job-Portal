                  ...
                  <div class="card" style="border-radius: 1rem;">
                    <div class="row g-0">
                      <div class="col-md-6 col-lg-5 d-none d-md-block">
                        <img src="assets/candidate2.jpg" alt="login form" class="img-fluid" style="width:100%; height: 80%; border-radius: 1rem 0 0 1rem;" />
                      </div>
                      <div class="col-md-6 col-lg-7 d-flex align-items-center">
                        <div class="card-body p-4 p-lg-5 text-black">
                          ...
                          <form action="LoginServlet" method="post">
                            ...
                            <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Applicant Sign IN</h5>
                            ...
                            <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="ApplicantReg.jsp"
